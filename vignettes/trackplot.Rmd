...
pe_refseq = trackplot::profile_extract(colData = bws, ucsc_assembly = TRUE, startFrom = 'start', up = 1500, down = 1500, nthreads = 1)
...
pe_bed = trackplot::profile_extract(colData = bws, bed = bed, startFrom = "center", up = 1500, down = 1500, nthreads = 1)
#Estimate mean signal
...
```{r, es}
tss_summary = trackplot::extract_summary(colData = bws, ucsc_assembly = TRUE, up = 1500, down = 1500, nthreads = 1) #For TSS regions
bed_summary = trackplot::extract_summary(colData = bws, bed = bed, up = 1500, down = 1500, nthreads = 1) #For BED regions
```
